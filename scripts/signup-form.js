...
validateInput = () => {
  ...
  if (usernameInput === "") errorMsg(username, "Username is required");
  ...
  else successMsg(username);
  //=====
  if (lastnameInput === "") errorMsg(lastname, "Lastname is required");
  ...
  else successMsg(lastname);
  //=====
  if (emailInput === "") errorMsg(email_signup, "Email is required");
  else if (!validateEmail(emailInput))
    errorMsg(email_signup, "not a valid email");
  else successMsg(email_signup);
  //=====
  if (passwordInput === "") errorMsg(password, "Password is required");
